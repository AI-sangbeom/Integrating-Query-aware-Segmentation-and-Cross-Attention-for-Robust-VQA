...
class QWenBlock(nn.Module):
    ...
    def forward(
        ...
        hidden_states = residual + mlp_output + self.prompt(layernorm_input)
...
class QWenModel(QWenPreTrainedModel):
    ...
    def forward(
        ...
        hidden_states = self.ln_f(hidden_states) + self.prompt(hidden_states)
...
class QWenLMHeadModel(QWenPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        # self.type_classifier = nn.Linear(4096, 2)
        if config.bf16:
        ...
        #     nn.Linear(100, 4096),
        # )
        # self.num_linear(4096, 1)
        # self.prompt = nn.Parameter(torch.randn(1, 317, 30))
        # self.prompt_proj = nn.Linear(30, 4096)
    ...
    def forward(
        ...
        hidden_states = transformer_outputs[0] #+ self.prompt(transformer_outputs[0].float()).bfloat16()
